...
export function StepSessionType() {
  ...
  return <div className="grid md:grid-cols-2 gap-4">
      <Card className={cn("cursor-pointer transition-all hover:shadow-md", selection.sessionType === 'diy' && "ring-2 ring-primary")} onClick={() => handleSelect('diy')}>
        <CardHeader>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground space-y-1">
            ...
            <li>• Self-operated session</li>
            <li>• Most affordable option</li>
          </ul>
        </CardContent>
      </Card>

      <Card className={cn("cursor-pointer transition-all hover:shadow-md", selection.sessionType === 'serviced' && "ring-2 ring-primary")} onClick={() => handleSelect('serviced')}>
        <CardHeader>
